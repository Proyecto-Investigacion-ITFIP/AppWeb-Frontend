    ...
    const Logout = () => {
      ...
      return (
          <button type="button" onClick={() => deleteToken()}>
            <NavLink to="/auth/index" className="sidebar-route text-red-600 hover:text-red-500">
              <div className="flex items-center">
                <i className="fas fa-sign-out-alt text-base" />
                <span className="text-base ml-2">Cerrar Sesión</span>
              </div>
            </NavLink>
          </button>
      );
      ...
      <div>
        ...
        >
          <div className="hidden xl:flex justify-start p-6 items-center space-x-3">
            ...
            <Link to="/inicio">
              <p className="text-2xl leading-6 text-white">CiclasMundo</p>
            </Link>
          </div>
          <div className="mt-6 flex flex-col justify-start items-center  pl-4 w-full border-gray-600 border-b space-y-3 pb-5 ">
            <button className="flex jusitfy-start items-center space-x-6 w-full hover:text-indigo-300 focus:outline-none  focus:text-indigo-400  text-white rounded ">
              <svg
            ...
            <button className="flex jusitfy-start items-center w-full hover:text-indigo-300 space-x-6 focus:outline-none text-white focus:text-indigo-400   rounded ">
              <svg
                className="fill-stroke"
                width={24}
                height={24}
              ...
              <Link to="/usuarios"  className="focus:text-indigo-400">
                <p className="text-base leading-4 ">Usuarios</p>
              </Link>
            </button>
            </PrivateComponent>
            <button className="flex jusitfy-start items-center w-full  space-x-6 focus:outline-none text-white focus:text-indigo-400 rounded hover:text-indigo-300">
            <svg
              className="fill-stroke"
              width={24}
              height={24}
            ...
            <Link to="/clientes"  className="focus:text-indigo-400">
              <p className="text-base leading-4 ">Clientes</p>
            </Link>
          </button>
          </div>
          <div className="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  ">
            ...
            >
              <p className="text-sm leading-5  uppercase">Mtr-Producto</p>
              <svg
                id="icon1"
                className={`${
                  menu[0] ? "" : "rotate-180"
            ...
            >
              <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                ...
                <Link to="/messeges">
                  <p className="text-base leading-4  ">Registrar Producto</p>
                </Link>
              </button>
              <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                <svg
          ...
          <div className="flex flex-col justify-start items-center   px-6 border-b border-gray-600 w-full  ">
            <button
              ...
              className="focus:outline-none focus:text-indigo-400  text-white flex justify-between items-center w-full py-5 space-x-14  "
            >
              <p className="text-sm leading-5 uppercase">Factura</p>
              <svg
                id="icon2"
            ...
            >
              <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                <i className="fas fa-file-invoice-dollar h-6 w-6"></i>
                <p className="text-base leading-4  ">Generar Factura</p>
              </button>
            </div>
          </div>
          <div className="flex flex-col justify-between items-center h-full pb-6   px-6  w-full  space-y-32 ">
            <button
              ...
              className="focus:outline-none focus:text-indigo-400  text-white flex justify-between items-center w-full py-5 space-x-14  "
            >
              <p className="text-sm leading-5  uppercase">Registro Ventas</p>
              <svg
                id="icon3"
                className={`${
                  menu[2] ? "" : "rotate-180 "
            ...
            >
              <button className="flex justify-start items-center space-x-6 hover:text-white focus:bg-gray-700 focus:text-white hover:bg-gray-700 text-gray-400 rounded px-3 py-2  w-full md:w-52">
                <i className="fas fa-cash-register h-6 w-6"></i>
                <p className="text-base leading-4  ">Registro Ventas</p>
              </button>
            </div>
            <Logout />
