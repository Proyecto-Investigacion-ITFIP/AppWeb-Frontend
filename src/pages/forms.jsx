    ...
    return (
        <div className='flex flex-col items-center justify-center'>
            ...
            <form className='grid grid-cols-2'>
                ...
                <input className='bg-gray-50 border border-gray-600 p-2 rounded-lg m-2' type='text' />
                <input className='bg-gray-50 border border-gray-600 p-2 rounded-lg m-2' type='text' />
                <button className='col-span-2 mx-2 my-2 bg-slate-900 transition duration-150 ease-in-out focus:outline-none hover:bg-slate-700 hover:text-sky-500 rounded text-gray-100 px-6 py-2 text-xs"'>
                Guardar Cambios
                </button>
            </form>
        </div>
